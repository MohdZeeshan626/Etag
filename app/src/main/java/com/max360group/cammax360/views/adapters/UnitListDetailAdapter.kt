...
open class UnitListDetailAdapter(var mFragment: Fragment, var mList: ArrayList<UnitRecord>?) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return  ListViewHolder(parent.inflate(R.layout.layout_unit_list_detail))
