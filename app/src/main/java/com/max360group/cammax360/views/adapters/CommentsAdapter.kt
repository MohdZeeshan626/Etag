...
class CommentsAdapter(var mFragment: Fragment) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    private var mList= mutableListOf<Comments>()
    ...
    fun updateFunction(list:List<Comments>){
        mList.clear()
        mList.addAll(list)
