...
class EmailListAdapter(var mFragment: Fragment) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    private var mEmailList = mutableListOf<EmailsModel>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return ListViewHolder(parent.inflate(R.layout.layout_email))
    }
    ...
    private inner class ListViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bindListView(i: Int) {
            ...
            itemView.etType.setText(mEmailList[absoluteAdapterPosition].type)
            itemView.etEmail.setText(mEmailList[absoluteAdapterPosition].email)
